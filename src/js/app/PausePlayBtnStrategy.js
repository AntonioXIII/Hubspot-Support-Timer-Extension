(function(){
  ...
  * @constructor
  */
  extLib.PausePlayBtnStrategy = function(timer, btn, playContent, 
    pauseContent) {
  ...
  extLib.PausePlayBtnStrategy.prototype = 
    Object.create(extLib.PausePlayStrategy.prototype);
  
  // Set the properties of this object to this object
  extLib.PausePlayBtnStrategy.prototype.constructor = 
    extLib.PausePlayBtnStrategy;
